...
export default function SettingsSection() {
  ...
  const avatarLabel = useMemo(() => {
    ...
    return initials || user?.avatarLabel || "CL";
  ...
  const handleSave = async (event) => {
    ...
    try {
      ...
      setStatus("Profil client mis à jour.");
    } catch (error) {
    ...
    return (
      <div className="min-h-screen pt-24 bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          <p className="text-muted-foreground">Cette page est un espace de parametres pour la section "{section}".</p>
        </div>
        <Footer />
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto pt-32 pb-16 px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-3xl font-bold mb-8 text-gray-900">Mon Profil Client</h1>
            ...
            <form onSubmit={handleSave} className="space-y-6">
              <div className="flex flex-col items-center gap-4 border-b border-border pb-6">
                <Avatar className="w-24 h-24">
                  <AvatarImage src={avatarPreview} alt={user?.name || "Profil client"} />
                ...
                <div className="w-full max-w-sm space-y-2">
                  ...
                  <label htmlFor="profile-image" className="flex cursor-pointer items-center justify-center gap-2 rounded-md border border-dashed border-border px-4 py-3 text-sm text-muted-foreground hover:border-primary hover:text-primary">
              ...
              <div className="space-y-2">
                ...
                <Input id="phone" value={formData.phone} onChange={(event) => setFormData({ ...formData, phone: event.target.value })} placeholder="+33 6..." />
              </div>
